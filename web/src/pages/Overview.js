...
export default function Overview() {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-semibold text-gray-900 dark:text-gray-100", children: "Overview" }), _jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "Live status and key metrics for the selected cluster." })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("label", { className: "flex items-center gap-2 text-sm text-gray-700", children: [_jsx("input", { type: "checkbox", checked: auto, onChange: (e) => setAuto(e.target.checked) }), `Auto refresh (${Math.max(1, Math.round(intervalMs / 1000))}s)`] }), _jsx("button", { onClick: () => refreshAll(), className: "button", children: "Refresh" }), _jsx("button", { onClick: () => setShowRefreshDialog(true), className: "button", children: "Settings" }), _jsx("div", { className: "ml-2 text-xs text-gray-500", children: lastUpdated ? `Last updated: ${new Date(lastUpdated).toLocaleTimeString()}` : 'No updates yet' })] })] }), _jsx(AutoRefreshDialog, { open: showRefreshDialog, onClose: () => setShowRefreshDialog(false), onSaved: () => {
                    try {
                        setIntervalMs(Number(localStorage.getItem('refresh_interval_ms') || intervalMs));
                    }
                    catch { }
                } }), err && _jsx("div", { className: "text-red-600 text-sm mb-2", children: err }), (varzQuery.error || jsInfoQuery.error || rttQuery.error) && (_jsx("div", { className: "text-red-600 text-sm mb-2", children: "Failed to fetch some data." })), _jsx("section", { "aria-label": "Key metrics", className: "mb-4", children: _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3", children: [_jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "Active Conns" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: varz?.connections ?? '-' })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "RTT" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: rtt == null ? '-' : fmtMs(rtt) })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "In Msgs/s" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: fmtRate(rates.inMsgs) })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "Out Msgs/s" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: fmtRate(rates.outMsgs) })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "Memory" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: `${Math.round((varz?.mem || 0) / 1024 / 1024)} MB` })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "CPU" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: varz?.cpu ?? '-' })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "Subscriptions" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: varz?.subscriptions ?? '-' })] }), _jsxs("div", { className: "card p-3", children: [_jsx("div", { className: "text-xs uppercase text-gray-500 mb-1", children: "Routes" }), _jsx("div", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: varz?.routes ?? '-' })] })] }) }), _jsxs("section", { children: [_jsx("h3", { className: "text-base font-medium text-gray-700 mb-2", children: "Server (varz)" }), varz ? (_jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3", children: [_jsxs(Card, { title: "Server", children: [_jsx(KV, { k: "ID", v: varz.server_id }), _jsx(KV, { k: "Version", v: varz.version }), _jsx(KV, { k: "Go", v: varz.go }), _jsx(KV, { k: "Host", v: varz.host }), _jsx(KV, { k: "Ports", v: `client ${varz.port}, http ${varz.http_port}` }), _jsx(KV, { k: "JetStream", v: String(varz.jetstream) }), _jsx(KV, { k: "Uptime", v: varz.uptime || '-' })] }), _jsxs(Card, { title: "Connections", children: [_jsx(KV, { k: "Num Conns", v: varz.connections }), _jsx(KV, { k: "Routes", v: varz.routes }), _jsx(KV, { k: "Subs", v: varz.subscriptions })] }), _jsxs(Card, { title: "Memory/CPU", children: [_jsx(KV, { k: "CPU", v: varz.cpu }), _jsx(KV, { k: "Mem", v: `${Math.round((varz.mem || 0) / 1024 / 1024)} MB` }), _jsx(KV, { k: "Cores", v: varz.cores })] }), _jsxs(Card, { title: "Health/Alerts", children: [_jsx(KV, { k: "Slow Consumers", v: varz?.slow_consumers ?? 0 }), _jsx(KV, { k: "Max Payload", v: fmtBytes(varz?.max_payload) }), _jsx(KV, { k: "Max Conns", v: varz?.max_connections ?? '-' }), _jsx(KV, { k: "Write Deadline", v: typeof varz?.write_deadline === 'number' ? `${varz.write_deadline}s` : (varz?.write_deadline || '-') })] }), _jsxs(Card, { title: "Latency", children: [_jsx(KV, { k: "RTT", v: rtt == null ? '-' : fmtMs(rtt) }), rttStats && (_jsxs(_Fragment, { children: [_jsx(KV, { k: "RTT Min", v: fmtMs(rttStats.min) }), _jsx(KV, { k: "RTT Avg", v: fmtMs(rttStats.avg) }), _jsx(KV, { k: "RTT Max", v: fmtMs(rttStats.max) })] })), _jsx("div", { className: "mt-2", children: _jsx(MiniLineChart, { data: rttHistRef.current.slice(), color: "#22c55e", height: 64, format: fmtMsShort }) })] }), _jsxs(Card, { title: "Throughput (live)", children: [_jsx(KV, { k: "In Msgs/s", v: fmtRate(rates.inMsgs) }), _jsx(KV, { k: "Out Msgs/s", v: fmtRate(rates.outMsgs) }), _jsx("div", { className: "mt-2", children: _jsx(MiniLineChart, { data: inMsgsHistRef.current.slice(), color: "#3b82f6", height: 48, format: (v) => `${fmtRate(v)} msg/s` }) }), _jsx("div", { className: "mt-2", children: _jsx(MiniLineChart, { data: outMsgsHistRef.current.slice(), color: "#a855f7", height: 48, format: (v) => `${fmtRate(v)} msg/s` }) }), _jsx(KV, { k: "In KB/s", v: fmtRate(rates.inBytes / 1024) }), _jsx(KV, { k: "Out KB/s", v: fmtRate(rates.outBytes / 1024) }), _jsx("div", { className: "mt-2", children: _jsx(MiniLineChart, { data: inBytesHistRef.current.slice(), color: "#06b6d4", height: 48, format: (v) => `${fmtRate(v / 1024)} KB/s` }) }), _jsx("div", { className: "mt-2", children: _jsx(MiniLineChart, { data: outBytesHistRef.current.slice(), color: "#f59e0b", height: 48, format: (v) => `${fmtRate(v / 1024)} KB/s` }) })] })] })) : (_jsx("div", { className: "text-gray-500", children: "Loading varz..." }))] }), _jsxs("section", { className: "mt-4", children: [_jsx("h3", { className: "text-base font-medium text-gray-700 mb-2", children: "JetStream Account" }), info ? (_jsx("pre", { className: "bg-gray-900 text-gray-100 text-sm rounded-lg p-4 overflow-auto", children: JSON.stringify(info, null, 2) })) : (_jsx("div", { className: "text-gray-500", children: "No JetStream account info or not enabled." }))] })] }));
}
function Card(props) {
